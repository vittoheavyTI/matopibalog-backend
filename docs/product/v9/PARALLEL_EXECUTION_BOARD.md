...
- `BLOCKERS_OPEN=0`.
- `HIGHS_OPEN=0`.
- `NEXT_STATUS=CAMPAIGN_D_CLOSED` (Campaign-B materialization, Campaign-C progress/eligibility/readiness, Route Intelligence V1, Dispatch V1, Operation Orchestrator V1 (E3.1/E3.2) e Campaign-D (replan pós-aprovação + rota no planejamento + multi-origem) concluídos fora deste board; RBV9-INV-031 dispatch real CLOSED em produção — PR #471, migration 079. Campaign-D fechou os 3 itens deferidos pelo Orchestrator V1, todos schema-free. Ver [DISPATCH_V1](./DISPATCH_V1.md), [OPERATION_ORCHESTRATOR_V1](./OPERATION_ORCHESTRATOR_V1.md) e [CAMPAIGN_D_REPLAN_ROUTE_MULTI_ORIGIN](./CAMPAIGN_D_REPLAN_ROUTE_MULTI_ORIGIN.md)).
