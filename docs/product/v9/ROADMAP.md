...
- **E1.1 Realtime** (RBV9-INV-053/093, D-017/D-027): substituir polling por push/subscription em lançamentos, notificações, torre.
- **E1.2 Lançamentos audit-safe** (RBV9-INV-052, D-018/D-019): estados pendente/aprovado/rejeitado/cancelado+motivo+ator uniformes.
- **E1.3 Separação financeira** (RBV9-INV-055, D-035): auditar/segregar KPIs operacional × SaaS.
- **E1.4 Scanner + viewer PDF-first** (RBV9-INV-044/047, D-016).
- **E1.5 Permissões templates+overrides** (RBV9-INV-018, D-006/D-008/D-010) — fundação para dashboards por papel (D-007).
- **E1.6 Paridade painel↔app** (RBV9-INV-054, D-020); UX/máscaras/sidebar (RBV9-INV-098/099).
- **Dependências:** E1.5 antes de D-007/D-011. **Gate:** sem regressão nos fluxos vivos; CI verde.
