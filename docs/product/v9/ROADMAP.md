...
- **E1.4 Scanner + viewer PDF-first** (RBV9-INV-044/047, D-016): **E1.4A em PR** — fundacao documents/security/web com migration 073 aditiva (gate `OWNER_MIGRATION_GATE_E14A` antes de merge/deploy), contrato v2 para `outro`, idempotencia de upload, auditoria minima, participantes operacionais e preview web PDF/imagem primeiro. Ver [E1.4A_DOCUMENTS_FOUNDATION_SECURITY_WEB](./E1.4A_DOCUMENTS_FOUNDATION_SECURITY_WEB.md).
...
- **Dependências:** E1.5 antes de D-007/D-011. **Estado:** Onda 1 (E1.1/E1.2/E1.3/E1.6 + E1.6A + E1.7) **DEPLOYADA em produção e tecnicamente CLOSED** (PR #435 `f43f009` + hotfix PR #437 `MERGE_SHA=569fde7` + PR #441 `MERGE_SHA=b695102`, migrations 070+071+072 aplicadas/rastreadas conforme seus gates, CI verde, sem regressão). `ONDA1_TECHNICAL_STATUS=CLOSED`; `ONDA1_APP_DEVICE_VALIDATION=DEFERRED_TO_MOBILE_RELEASE_TRAIN_M1` (itens `MOBILE-M1-001/002`; **não bloqueia** o roadmap). **P2/E1.5 = `CLOSED`**; próxima macrofrente = **E1.4A Documents foundation/security/web**.
