          ...
          <tbody className="divide-y divide-gray-50">
            {filtered.map(a => (
              <tr key={a.id} className="hover:bg-gray-50/50">
                <td className="p-4"><div><p className="font-bold text-gray-800">{a.empresa}</p><p className="text-xs text-gray-400">{a.tipo === 'autonomo' ? 'Autônomo' : 'Empresa'} · {a.cnpj || 'sem documento'}</p></div></td>
