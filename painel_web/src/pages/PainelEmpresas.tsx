  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="flex flex-wrap justify-between items-center gap-4">
        ...
        <button onClick={() => { setEditing(null); setFormDados({ nome: '', cnpj: '', email: '', telefone: '', plano_id: '' }); setShowModal(true); }} className="flex items-center px-4 py-2.5 bg-blue-600 text-white rounded-xl font-medium text-sm hover:bg-blue-700 active:scale-95"><Plus size={18} className="mr-1.5" /> Nova Empresa</button>
      </div>
