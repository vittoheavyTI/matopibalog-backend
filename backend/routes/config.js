...
router.put('/empresa', verifyToken, isAdmin, verificarEmpresa, verificarPlano, configController.updateEmpresaConfig);
router.get('/codigo-convite', verifyToken, isAdmin, configController.getCodigoConvite);
router.post('/codigo-convite/regenerar', verifyToken, isAdmin, verificarEmpresa, verificarPlano, configController.regenerarCodigoConvite);
