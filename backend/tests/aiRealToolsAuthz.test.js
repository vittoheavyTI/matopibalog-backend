...
test('tools reais registradas com permissão canônica', () => {
  ...
  assert.deepEqual(names, ['commercial.current_plan.summary', 'fleet.current.summary', 'operation.command_center.summary', 'operation.freights.attention', 'route.estimate']);
